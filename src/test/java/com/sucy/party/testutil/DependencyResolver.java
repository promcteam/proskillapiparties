...
//        return downloadSkillAPI(pieces[0], pieces[1], pieces[2]);
    }

    private static File downloadSkillAPI(String groupId, String artifact, String version) throws FileNotFoundException {
        ...
        try (BufferedInputStream inputStream = new BufferedInputStream(new URL(url).openStream());
            ...
            throw new RuntimeException("Could not fetch SkillAPI dependency");
        }
    }
    ...
    private static String findSkillUrl(String groupId, String artifact, String version) throws FileNotFoundException {
        ...
        for (String rep : repositories) {
            ...
            try (BufferedReader read = new BufferedReader(new InputStreamReader(new URL(repository).openStream()))) {
                ...
                // handles IO exceptions
                throw new RuntimeException("Could not fetch SkillAPI repository");
            }
